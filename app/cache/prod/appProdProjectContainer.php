...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'sonata.admin.articles' => 'getSonata_Admin_ArticlesService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'a2_symfony', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'\\vendor\\mremi\\contact-bundle\\Mremi\\ContactBundle\\Resources\\config\\doctrine') => 'Mremi\\ContactBundle\\Entity'));
        ...
        $c->setEntityNamespaces(array('AppBundle' => 'AppBundle\\Entity', 'MremiContactBundle' => 'Mremi\\ContactBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_51d404d8469b51860f5aa1ee2a66012ca0b41471fee781aa16eb4b31f922bcf2');
        return $instance;
    }
    ...
    {
        return $this->services['mremi_contact.contact_controller'] = new \Mremi\ContactBundle\Controller\ContactController($this->get('event_dispatcher'), $this->get('mremi_contact.form_factory'), $this->get('mremi_contact.contact_manager'), $this->get('router'), $this->get('session'), $this->get('templating'));
    }
    protected function getMremiContact_ContactFormTypeService()
    {
        return $this->services['mremi_contact.contact_form_type'] = new \Mremi\ContactBundle\Form\Type\ContactType($this->get('mremi_contact.subject_provider.noop'), 'Mremi\\ContactBundle\\Model\\Contact', 'genemu_captcha');
    }
    ...
    {
        return $this->services['mremi_contact.mailer'] = new \Mremi\ContactBundle\Mailer\TwigSwiftMailer($this->get('swiftmailer.mailer.default'), $this->get('twig'), 'MremiContactBundle:Contact:email.txt.twig', array('matthieu.posnic@gmail.com' => 'Matthieu Posnic'), array());
    }
    ...
    protected function getSonata_Admin_ArticlesService()
    {
        $instance = new \AppBundle\Admin\ArticleAdmin('sonata.admin.articles', 'AppBundle\\Entity\\Article', 'SonataAdminBundle:CRUD');
    ...
    {
        $instance = new \AppBundle\Admin\TagAdmin('sonata.admin.category', 'AppBundle\\Entity\\Category', 'SonataAdminBundle:CRUD');
        $instance->setFormTheme(array(0 => 'SonataDoctrineORMAdminBundle:Form:form_admin_fields.html.twig'));
        $instance->setFilterTheme(array(0 => 'SonataDoctrineORMAdminBundle:Form:filter_admin_fields.html.twig'));
        $instance->setManagerType('orm');
        $instance->setModelManager($this->get('sonata.admin.manager.orm'));
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'sonata.admin.articles', 1 => 'sonata.admin.tags', 2 => 'sonata.admin.category', 3 => 'sonata.admin.user'));
        $instance->setAdminGroups(array('Articles' => array('label' => 'Articles', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => array('admin' => 'sonata.admin.articles', 'label' => '', 'route' => '', 'route_params' => array()), 1 => array('admin' => 'sonata.admin.tags', 'label' => '', 'route' => '', 'route_params' => array()), 2 => array('admin' => 'sonata.admin.category', 'label' => '', 'route' => '', 'route_params' => array()))), 'User' => array('label' => 'User', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => array('admin' => 'sonata.admin.user', 'label' => '', 'route' => '', 'route_params' => array())))));
        $instance->setAdminClasses(array('AppBundle\\Entity\\Article' => array(0 => 'sonata.admin.articles'), 'AppBundle\\Entity\\Tag' => array(0 => 'sonata.admin.tags'), 'AppBundle\\Entity\\Category' => array(0 => 'sonata.admin.category'), 'AppBundle\\Entity\\User' => array(0 => 'sonata.admin.user')));
        return $instance;
    }
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'sonata.admin.articles', 1 => 'sonata.admin.tags', 2 => 'sonata.admin.category', 3 => 'sonata.admin.user'), $this);
    }
    ...
    {
        $instance = new \AppBundle\Admin\TagAdmin('sonata.admin.tags', 'AppBundle\\Entity\\Tag', 'SonataAdminBundle:CRUD');
        $instance->setFormTheme(array(0 => 'SonataDoctrineORMAdminBundle:Form:form_admin_fields.html.twig'));
        $instance->setFilterTheme(array(0 => 'SonataDoctrineORMAdminBundle:Form:filter_admin_fields.html.twig'));
        $instance->setManagerType('orm');
        $instance->setModelManager($this->get('sonata.admin.manager.orm'));
    ...
    {
        $instance = new \AppBundle\Admin\TagAdmin('sonata.admin.user', 'AppBundle\\Entity\\User', 'SonataAdminBundle:CRUD');
        $instance->setFormTheme(array(0 => 'SonataDoctrineORMAdminBundle:Form:form_admin_fields.html.twig'));
        $instance->setFilterTheme(array(0 => 'SonataDoctrineORMAdminBundle:Form:filter_admin_fields.html.twig'));
        $instance->setManagerType('orm');
        $instance->setModelManager($this->get('sonata.admin.manager.orm'));
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xliff', ($this->targetDirs[3].'\\vendor\\mremi\\contact-bundle\\Mremi\\ContactBundle/Resources/translations\\MremiContactBundle.en.xliff'), 'en', 'MremiContactBundle');
        $instance->addResource('xliff', ($this->targetDirs[3].'\\vendor\\mremi\\contact-bundle\\Mremi\\ContactBundle/Resources/translations\\MremiContactBundle.fr.xliff'), 'fr', 'MremiContactBundle');
        $instance->addResource('xliff', ($this->targetDirs[3].'\\vendor\\mremi\\contact-bundle\\Mremi\\ContactBundle/Resources/translations\\validators.en.xliff'), 'en', 'validators');
        $instance->addResource('xliff', ($this->targetDirs[3].'\\vendor\\mremi\\contact-bundle\\Mremi\\ContactBundle/Resources/translations\\validators.fr.xliff'), 'fr', 'validators');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\vendor\\mremi\\contact-bundle\\Mremi\\ContactBundle/Resources/views'), 'MremiContact');
